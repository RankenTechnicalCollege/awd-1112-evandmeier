...
public class LoginActivityTest {
    ...
    private static final int LOGIN_EMAIL_INPUT = R.id.input_email_address;
    private static final int LOGIN_PASSWORD_INPUT = R.id.input_password;
    private static final int LOGIN_BUTTON = R.id.button_login;
    private static final int HOME_FAB = R.id.fab;
    private static final int ERROR_INVALID_CREDENTIALS = R.string.login_error;

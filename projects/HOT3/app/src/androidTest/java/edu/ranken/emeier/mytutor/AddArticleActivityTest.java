...
public class AddArticleActivityTest {
    ...
    private static final int ARTICLE_TITLE_INPUT = R.id.input_article_title;
    private static final int ARTICLE_AUTHOR_INPUT = R.id.input_article_author;
    private static final int ARTICLE_PUBLISHED_INPUT = R.id.input_published_date;
    private static final int ARTICLE_PUBLISHED_BUTTON = R.id.imageButton;
    private static final int ARTICLE_TOPIC_INPUT = R.id.topic_spinner;
    private static final int ARTICLE_LINK_INPUT = R.id.input_link;
    private static final int ERROR_INCOMPLETE = R.string.alert_invalid_data;
    ...
    public void saveValidArticle() {
        ...
        //String articlePublished = "02/13/2019";
        ...
        onView(withId(ARTICLE_PUBLISHED_BUTTON)).perform(click());
